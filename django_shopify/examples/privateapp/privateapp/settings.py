# Django setting for privateapp_app.
import os
...
SECRET_KEY = 'mih%a(o7=t#2xu%^==56cw!)#6(gex2rl+s-7lna^ew!f$(0g+'
...
ROOT_URLCONF = 'privateapp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'privateapp.wsgi.application'
